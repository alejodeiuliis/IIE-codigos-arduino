...
// LEDs del Shield: Agregamos los modificadores "const" y "static" a las variables. 
...
// c - ¿Cuál es el inconveniente de usar esta función "delay" para hacer parpadear un LED? 
// d - ¿Es posible emplear esta función (delay) para hacer parpadear dos o más LEDs a frecuencias independientes?
// e - ¿Es una buena idea realizar la inversión del LED_2 en una línea en lugar de escribir primero la lectura y después la escritura? (Pista: Pensar en el tiempo de ejecución y memoria)
