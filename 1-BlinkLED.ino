...
// d - ¿Es una buena idea realizar la inversión del LED_2 en una línea en lugar de escribir primero la lectura y después la escritura? (Pista: Pensar en el tiempo de ejecución y memoria)
