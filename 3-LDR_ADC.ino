...
// a - ¿Qué pasa si la variable LDR_valor se crea con el modificador const?
// b - ¿Qué valor máximo puede devolver la función analogRead? ¿A qué valor de tensión equivale?
