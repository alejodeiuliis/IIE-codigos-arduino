...
// Entreparéntesis se encuentra el tipo de dato que espera recibir la función y "LED" es una variable interna que solo tiene utilidad dentro de la función, delimitada entre "{".
