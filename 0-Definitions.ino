...
// Actividades:
// 1 - Compilar el programa (CTRL+R). Luego conectar el Arduino+Shield y ver que pasa. Pensar por qué estos resultados.

// Preguntas: 
// a - ¿Por qué al establecer el LED_0 en estado alto el LED no se enciende? (Pista: Revisar el circuito del Shield).
// b - ¿Qué pasaría al comentar la línea 97 (pinMode(LED_1, OUTPUT); colocando "//" al principio del renglón? 
// c - ¿Qué sentido tiene el loop vacío? ¿No se ejecuta nada? ¿Puedo borrar entonces la línea 109 y 110?
