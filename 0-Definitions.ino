...
// Se graban en la memoria SRAM del Arduino, que tiene un límite (2kB en el caso de ATMEGA328).
...
// 2- Pensar por qué estos resultados. Revisar el circuito del Shield y ver como están conectados los LEDs.
