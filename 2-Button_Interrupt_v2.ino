...
// Espero Tiempo_Espera_us para filtrar rebote del botón
...
// a - Presionar el botón primero sin soltarlo, ver que pasa y luego soltar el botón. ¿Por qué se enciende el LED al soltar el botón y no al presionarlo? (pensar en RISING y en INPUT_PULLUP)
// b - ¿Cuál es la ventaja de hacer una función de interrupción para detectar si se presiona el pulsador frente al ejemplo del código anterior?
// c - Qué significa la frase "las variables locales dentro de la función interrupción perderán el alcance?"
